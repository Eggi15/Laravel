...
<section class="banner-area relative" id="home">
	...
	<div class="container">
		<div class="row fullscreen d-flex align-items-center justify-content-center">
			<div class="abbout-content col-lg-12">
				<h1 class="text-white">
					Pendaftaran			
				</h1>
	...
	<div class="container">
		<div class="row justify-content-between align-items-center">
			<div class="col-lg-3 col-md-6 search-course-left">
				...
				<p>
					Dengan kurikulum yang update yang sudah di sesuaikan dengan kebutuhan pasar, kami menjamin lulus langsung mendapat perkerjaan.
				</p>
			</div>
